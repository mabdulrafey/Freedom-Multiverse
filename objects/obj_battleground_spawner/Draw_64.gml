...
if (global.north_state == "playing" && state == "tutorial") {
    ...
    draw_set_color(c_black);
    draw_text(_cx + 2, _cy - 128, "EARN YOUR FREEDOM"); 
    draw_set_color(_col_gold);
    draw_text(_cx, _cy - 130, "EARN YOUR FREEDOM");   
    
    draw_set_font(-1);
    draw_set_color(c_white);
    
    draw_text_transformed(_cx, _cy - 75, "You have to fight 5 waves of very strong and capable soldiers.", 1.25, 1.25, 0);
    draw_text_transformed(_cx, _cy - 50, "In the last wave, you must fight their commander to earn your freedom.", 1.25, 1.25, 0);

    draw_set_color(c_white);
    draw_text_transformed(_cx, _cy + 10, "Movement: Arrow Keys (Up, Left, Right) Attack: Press 'S' to Swing Sword", 1.25, 1.25, 0);
    draw_text_transformed(_cx, _cy + 35, "Try all the movements before hitting enter", 1.25, 1.25, 0);

    draw_set_color(c_dkgray);
    draw_line(_cx - 150, _cy + 75, _cx + 150, _cy + 75);

    draw_set_color(c_white);
    draw_text_transformed(_cx, _cy + 110, "[ PRESS ENTER TO START WAVES ]", 1.25, 1.25, 0);
}
...
if (global.north_state == "win") {
    ...
    draw_text_transformed(_cx, _cy + 50, "[ Press ENTER to try again ]", 1.25, 1.25, 0);
