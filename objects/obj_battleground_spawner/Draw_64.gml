...
if (global.north_state == "playing" && state == "tutorial") {
    ...
    draw_text(_cx, _cy - 50, "In the last wave, you must fight their commander to earn your freedom.");

    draw_set_color(_col_text);
    draw_text(_cx, _cy + 10, "Movement: Arrow Keys (Up, Left, Right) Attack: Press 'S' to Swing Sword");
    draw_text(_cx, _cy + 35, "Try all the movements before hitting enter");

    draw_set_color(c_dkgray);
    draw_line(_cx - 150, _cy + 75, _cx + 150, _cy + 75);

    draw_set_color(c_white);
    draw_text(_cx, _cy + 110, "[ PRESS ENTER TO START WAVES ]");
}
